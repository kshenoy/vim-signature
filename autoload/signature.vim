...
function! signature#Input()                       " {{{2
  ...
  if g:SignatureMapInt.PlaceNextMark    == "<CR>"    && l:ascii == 13  | return s:ToggleMark('next')     | endif
  if g:SignatureMapInt.PlaceNextMark    == "<Space>" && l:ascii == 32  | return s:ToggleMark('next')     | endif
  if l:char == eval( '"\' . g:SignatureMapInt.PlaceNextMark . '"' )    | return s:ToggleMark('next')     | endif

  if g:SignatureMapInt.ToggleMarkAtLine == "<CR>"    && l:ascii == 13  | return s:ToggleMarkAtLine()     | endif
  if g:SignatureMapInt.ToggleMarkAtLine == "<Space>" && l:ascii == 32  | return s:ToggleMarkAtLine()     | endif
  if l:char == eval( '"\' . g:SignatureMapInt.ToggleMarkAtLine . '"' ) | return s:ToggleMarkAtLine()     | endif

  if g:SignatureMapInt.PurgeMarksAtLine == "<CR>"    && l:ascii == 13  | return s:PurgeMarksAtLine()     | endif
  if g:SignatureMapInt.PurgeMarksAtLine == "<Space>" && l:ascii == 32  | return s:PurgeMarksAtLine()     | endif
  if l:char == eval( '"\' . g:SignatureMapInt.PurgeMarksAtLine . '"' ) | return s:PurgeMarksAtLine()     | endif

  if g:SignatureMapInt.PurgeMarks       == "<CR>"    && l:ascii == 13  | return signature#PurgeMarks()   | endif
  if g:SignatureMapInt.PurgeMarks       == "<Space>" && l:ascii == 32  | return signature#PurgeMarks()   | endif
  if l:char == eval( '"\' . g:SignatureMapInt.PurgeMarks . '"' )       | return signature#PurgeMarks()   | endif

  if g:SignatureMapInt.PurgeMarkers     == "<CR>"    && l:ascii == 13  | return signature#PurgeMarkers() | endif
  if g:SignatureMapInt.PurgeMarkers     == "<Space>" && l:ascii == 32  | return signature#PurgeMarkers() | endif
  if l:char == eval( '"\' . g:SignatureMapInt.PurgeMarkers . '"' )     | return signature#PurgeMarkers() | endif
